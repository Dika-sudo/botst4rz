...
//
const BotName = 'Bot Rasya'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/rasya.gaming.5828'; // Nama Instagramlu cok
const whatsapplu = '088-1310-0198'; // Nomor whatsapplu cok
const kapanbotaktif = '13 JAM'; // Kapan bot lu aktif
const grupch1 = 'GAK ADA GRUP'; // OFFICIAL GRUP LU 1
const grupch2 = 'GAK ADA GRUP'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @DikaIsReal'))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @DikaIsReal`)
})
